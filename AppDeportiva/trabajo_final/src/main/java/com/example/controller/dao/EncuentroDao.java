...
<<<<<<< HEAD:AppDeportiva/trabajo_final/src/main/java/com/example/controller/dao/EncuentroDao.java
    public LinkedList getListAll() {
        if(listAll == null){
=======
    public LinkedList<Encuentro> getListAll() {
        if (listAll == null) {
>>>>>>> origin/feature/JoseRiofrio:trabajo_final/src/main/java/com/example/controller/dao/EncuentroDao.java
